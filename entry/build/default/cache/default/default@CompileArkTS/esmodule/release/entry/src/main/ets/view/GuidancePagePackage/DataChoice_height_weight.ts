...
class DataChoice_height_weight extends ViewPU {
    ...
    setInitiallyProvidedValue(a: DataChoice_height_weight_Params) {
        if (a.message !== undefined) {
            this.message = a.message;
        }
        if (a.userData_height !== undefined) {
            this.userData_height = a.userData_height;
        }
        if (a.userData_weight !== undefined) {
            this.userData_weight = a.userData_weight;
        }
    }
    updateStateVars(a: DataChoice_height_weight_Params) {
    }
    purgeVariableDependenciesOnElmtId(a) {
        this.__message.purgeDependencyOnElmtId(a);
        this.__userData_height.purgeDependencyOnElmtId(a);
        this.__userData_weight.purgeDependencyOnElmtId(a);
    }
    aboutToBeDeleted() {
    ...
    set userData_height(a: number) {
        this.__userData_height.set(a);
    }
    //用户选择体重，默认为60kg
    ...
    set userData_weight(a: number) {
        this.__userData_weight.set(a);
    }
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((c, d) => {
                if (d) {
                    ...
                    ViewPU.create(new 
                    //进度条
                    Progressbar(this, { value: 50 }, undefined, c, e));
                }
                else {
        ...
        this.observeComponentCreation2((b, c) => {
            ...
            //身高滑块
            Slider.onChange((e: number) => {
                this.userData_height = e;
            });
        }, Slider);
        this.observeComponentCreation2((b, c) => {
            //体重文字
        ...
        Blank.pop();
        {
            this.observeComponentCreation2((c, d) => {
                if (d) {
                    ...
                    ViewPU.create(new bottomNextStep(this, { index: 2 }, undefined, c, e));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(c, {});
                }
