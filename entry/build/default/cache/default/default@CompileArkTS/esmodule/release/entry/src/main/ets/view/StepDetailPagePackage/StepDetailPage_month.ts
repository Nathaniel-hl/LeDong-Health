...
class StepDetailPage_month extends ViewPU {
    ...
    setInitiallyProvidedValue(a: StepDetailPage_month_Params) {
    }
    updateStateVars(a: StepDetailPage_month_Params) {
    }
                ...
                this.updateFuncByElmtId.set(e, b);
                {
                    this.observeComponentCreation2((h, i) => {
                        if (i) {
                            ...
                            ViewPU.create(new TimeChooser(this, { time: 2 }, undefined, h, j));
                        }
                        else {
