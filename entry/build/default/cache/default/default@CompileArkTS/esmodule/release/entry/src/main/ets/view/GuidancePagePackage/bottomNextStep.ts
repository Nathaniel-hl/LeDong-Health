...
export default class bottomNextStep extends ViewPU {
    ...
    setInitiallyProvidedValue(a: bottomNextStep_Params) {
        if (a.hasBefore !== undefined) {
            this.hasBefore = a.hasBefore;
        }
        if (a.hasNext !== undefined) {
    ...
    updateStateVars(a: bottomNextStep_Params) {
    }
