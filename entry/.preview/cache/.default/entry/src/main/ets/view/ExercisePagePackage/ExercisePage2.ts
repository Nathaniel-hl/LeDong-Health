...
class ExercisePage2 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("view/ExercisePagePackage/ExercisePage2.ets(27:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //首页，搜索栏
            Row.create({ space: 20 });
            Row.debugLine("view/ExercisePagePackage/ExercisePage2.ets(29:7)");
            //首页，搜索栏
            Row.height('10%');
            //首页，搜索栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('运动');
            Text.debugLine("view/ExercisePagePackage/ExercisePage2.ets(30:9)");
            Text.fontSize(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Search.debugLine("view/ExercisePagePackage/ExercisePage2.ets(36:9)");
            //searchHeader()
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("view/ExercisePagePackage/ExercisePage2.ets(51:7)");
            //运动选择按钮
            List.height('5%');
            //运动选择按钮
            List.width('90%');
            ...
            const forEachItemGenFunction = _item => {
                const exerciseChoice = _item;
                {
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("view/ExercisePagePackage/ExercisePage2.ets(53:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                    ...
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Button.debugLine("view/ExercisePagePackage/ExercisePage2.ets(54:13)");
                            ...
                            Button.fontColor(Color.Black);
                            Button.backgroundColor(this.curExerciseChoice == exerciseChoice ? { "id": 16777223, "type": 10001, params: [], "bundleName": "com.example.wutsport", "moduleName": "entry" } : Color.White);
                            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("view/ExercisePagePackage/ExercisePage2.ets(75:7)");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //消息提示
            Row.create();
            Row.debugLine("view/ExercisePagePackage/ExercisePage2.ets(78:7)");
            //消息提示
            Row.width('90%');
            //消息提示
            Row.height('5%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/ExercisePagePackage/ExercisePage2.ets(79:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ExercisePagePackage/ExercisePage2.ets(84:9)");
            Text.fontSize(20);
            Text.padding({ left: 10 });
            Text.opacity(0.9);
            Text.fontColor(Color.Black);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //打卡计划推荐+每日打卡领金币
            Row.create();
            Row.debugLine("view/ExercisePagePackage/ExercisePage2.ets(101:7)");
            //打卡计划推荐+每日打卡领金币
            Row.height('5%');
            //打卡计划推荐+每日打卡领金币
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('打卡计划推荐   ');
            Text.debugLine("view/ExercisePagePackage/ExercisePage2.ets(102:9)");
            Text.fontSize(25);
            Text.padding({ left: '5%' });
            Text.fontColor(Color.Black);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('每日打卡领金币');
            Text.debugLine("view/ExercisePagePackage/ExercisePage2.ets(107:9)");
            Text.fontSize(20);
            Text.opacity(0.6);
            Text.fontColor(Color.Black);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("view/ExercisePagePackage/ExercisePage2.ets(117:7)");
            //健康数据图片
            List.width('100%');
            //健康数据图片
            List.listDirection(Axis.Horizontal);
        ...
        }, List);
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("view/ExercisePagePackage/ExercisePage2.ets(118:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/ExercisePagePackage/ExercisePage2.ets(121:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/ExercisePagePackage/ExercisePage2.ets(124:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
