...
export default class CommunityServiceCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("view/CommunityPage/CommunityServiceCard.ets(15:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/CommunityPage/CommunityServiceCard.ets(16:7)");
            Text.fontSize(25);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("view/CommunityPage/CommunityServiceCard.ets(22:7)");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("view/CommunityPage/CommunityServiceCard.ets(23:9)");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.datas[this.index].image);
            Image.debugLine("view/CommunityPage/CommunityServiceCard.ets(24:9)");
...
if (getPreviewComponentFlag()) {
    storePreviewComponents(1, "CommunityServiceCard", new CommunityServiceCard(undefined, {}));
    previewComponent();
}
else {
}
