...
class MinePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("view/MinePagePackage/MinePage.ets(17:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //顶部图案
            Stack.create();
            Stack.debugLine("view/MinePagePackage/MinePage.ets(20:7)");
            //顶部图案
            Stack.width('100%');
            //顶部图案
            Stack.height('20%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/MinePagePackage/MinePage.ets(21:9)");
            Image.layoutWeight(0);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777236, "type": 20000, params: [], "bundleName": "com.example.wutsport", "moduleName": "entry" });
            Image.debugLine("view/MinePagePackage/MinePage.ets(23:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //中部内容
            Column.create();
            Column.debugLine("view/MinePagePackage/MinePage.ets(32:7)");
            //中部内容
            Column.height('65%');
            //中部内容
            Column.backgroundColor({ "id": 16777219, "type": 10001, params: [], "bundleName": "com.example.wutsport", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //个人展示方块
            Column.create();
            Column.debugLine("view/MinePagePackage/MinePage.ets(34:9)");
            //个人展示方块
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("view/MinePagePackage/MinePage.ets(35:11)");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //头像
            Image.create({ "id": 16777271, "type": 20000, params: [], "bundleName": "com.example.wutsport", "moduleName": "entry" });
            Image.debugLine("view/MinePagePackage/MinePage.ets(37:13)");
            //头像
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create(30);
            Blank.debugLine("view/MinePagePackage/MinePage.ets(45:13)");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //名称+个性签名
            Column.create();
            Column.debugLine("view/MinePagePackage/MinePage.ets(47:13)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.user_name);
            Text.debugLine("view/MinePagePackage/MinePage.ets(48:15)");
            Text.fontSize(30);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create('20%');
            Blank.debugLine("view/MinePagePackage/MinePage.ets(51:15)");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.user_signature);
            Text.debugLine("view/MinePagePackage/MinePage.ets(52:15)");
            Text.fontSize(20);
            Text.opacity(0.7);
            Text.fontColor(Color.Black);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/MinePagePackage/MinePage.ets(59:11)");
            Text.padding({ top: '10%' });
            Text.fontSize(25);
            Text.fontColor(Color.Black);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //兴趣栏
            Column.create();
            Column.debugLine("view/MinePagePackage/MinePage.ets(70:9)");
            //兴趣栏
            Column.height('15%');
            //兴趣栏
            Column.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //兴趣栏文字
            Text.create('兴趣栏');
            Text.debugLine("view/MinePagePackage/MinePage.ets(72:11)");
            //兴趣栏文字
            Text.fontColor(Color.Black);
        }, Text);
        //兴趣栏文字
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //兴趣卡片
            Row.create();
            Row.debugLine("view/MinePagePackage/MinePage.ets(76:11)");
            //兴趣卡片
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //其他页面选项
            List.create();
            List.debugLine("view/MinePagePackage/MinePage.ets(92:9)");
            //其他页面选项
            List.height('50%');
            //其他页面选项
        ...
        }, List);
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("view/MinePagePackage/MinePage.ets(94:11)");
                if (!isInitialRender) {
                    //金币换奖品选项
                    ListItem.pop();
                }
            ...
            const deepRenderFunction = (elmtId, isInitialRender) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("view/MinePagePackage/MinePage.ets(95:13)");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("view/MinePagePackage/MinePage.ets(96:15)");
                    Row.width('100%');
                    Row.height('30%');
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('金币换奖品');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(97:17)");
                    Text.fontSize(25);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("view/MinePagePackage/MinePage.ets(100:17)");
                    Text.opacity(0.5);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("view/MinePagePackage/MinePage.ets(103:17)");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('>');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(104:17)");
                    Text.fontSize(50);
                    Text.fontColor(Color.Black);
                    Text.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("view/MinePagePackage/MinePage.ets(113:15)");
                    Divider.width('100%');
                }, Divider);
                Column.pop();
                //金币换奖品选项
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/MinePagePackage/MinePage.ets(118:11)");
                if (!isInitialRender) {
                    //运动周月年报告跳转页面
                    ListItem.pop();
                }
            ...
            const deepRenderFunction = (elmtId, isInitialRender) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("view/MinePagePackage/MinePage.ets(119:13)");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("view/MinePagePackage/MinePage.ets(120:15)");
                    Row.width('100%');
                    Row.height('30%');
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('运动周月年报告');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(121:17)");
                    Text.fontColor(Color.Black);
                    Text.fontSize(25);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("view/MinePagePackage/MinePage.ets(124:17)");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('>');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(125:17)");
                    Text.fontSize(50);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("view/MinePagePackage/MinePage.ets(131:15)");
                    Divider.width('100%');
                }, Divider);
                Column.pop();
                //运动周月年报告跳转页面
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/MinePagePackage/MinePage.ets(136:11)");
                if (!isInitialRender) {
                    //客服帮助跳转页面
                    ListItem.pop();
                }
            ...
            const deepRenderFunction = (elmtId, isInitialRender) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("view/MinePagePackage/MinePage.ets(137:13)");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("view/MinePagePackage/MinePage.ets(138:15)");
                    Row.width('100%');
                    Row.height('30%');
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('客服帮助');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(139:17)");
                    Text.fontSize(25);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("view/MinePagePackage/MinePage.ets(142:17)");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('>');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(143:17)");
                    Text.fontSize(50);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("view/MinePagePackage/MinePage.ets(149:15)");
                    Divider.width('100%');
                }, Divider);
                Column.pop();
                //客服帮助跳转页面
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/MinePagePackage/MinePage.ets(154:11)");
                if (!isInitialRender) {
                    //问卷调查页面
                    ListItem.pop();
                }
            ...
            const deepRenderFunction = (elmtId, isInitialRender) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("view/MinePagePackage/MinePage.ets(155:13)");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("view/MinePagePackage/MinePage.ets(156:15)");
                    Row.width('100%');
                    Row.height('30%');
                    Row.onClick(() => {
                        router.pushUrl({
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('问卷调查');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(157:17)");
                    Text.fontSize(25);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("view/MinePagePackage/MinePage.ets(160:17)");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('>');
                    Text.debugLine("view/MinePagePackage/MinePage.ets(161:17)");
                    Text.fontSize(50);
                    Text.fontColor(Color.Black);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("view/MinePagePackage/MinePage.ets(172:15)");
                    Divider.width('100%');
                }, Divider);
                Column.pop();
                //问卷调查页面
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //底部切换页面选择
            Blank.create();
            Blank.debugLine("view/MinePagePackage/MinePage.ets(189:7)");
        }, Blank);
        //底部切换页面选择
        Blank.pop();
        {
