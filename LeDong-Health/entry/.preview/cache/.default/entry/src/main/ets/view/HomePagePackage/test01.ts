...
class HomePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("view/HomePagePackage/test01.ets(17:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //首页，搜索栏
            Row.create({ space: 20 });
            Row.debugLine("view/HomePagePackage/test01.ets(19:7)");
            //首页，搜索栏
            Row.height('10%');
            //首页，搜索栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('首页');
            Text.debugLine("view/HomePagePackage/test01.ets(20:9)");
            Text.fontSize(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/HomePagePackage/test01.ets(30:7)");
            //我的步行+日期
            Text.fontSize(25);
            //我的步行+日期
            Text.fontWeight(4);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/HomePagePackage/test01.ets(36:7)");
            //步数图案
            Image.width('100%');
            //步数图案
            Image.height('30%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //活动数据+编辑按钮
            Row.create();
            Row.debugLine("view/HomePagePackage/test01.ets(48:7)");
            //活动数据+编辑按钮
            Row.alignItems(VerticalAlign.Bottom);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('活动数据');
            Text.debugLine("view/HomePagePackage/test01.ets(49:9)");
            Text.fontSize(25);
            Text.fontWeight(4);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('编辑');
            Text.debugLine("view/HomePagePackage/test01.ets(54:9)");
            Text.fontSize(20);
            Text.fontWeight(5);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //活动数据图片
            Row.create();
            Row.debugLine("view/HomePagePackage/test01.ets(61:7)");
            //活动数据图片
            Row.height('20%');
            //活动数据图片
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/HomePagePackage/test01.ets(62:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/HomePagePackage/test01.ets(71:9)");
            Image.height('100%');
            Image.width('50%');
            Image.autoResize(true);
            Image.padding({ left: 10, right: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //底端选择栏
            Blank.create();
            Blank.debugLine("view/HomePagePackage/test01.ets(82:7)");
        }, Blank);
        //底端选择栏
        Blank.pop();
        {
