...
export default class interestCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("view/MinePagePackage/interestCard.ets(10:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/MinePagePackage/interestCard.ets(11:7)");
            Text.fontSize(20);
...
if (getPreviewComponentFlag()) {
    storePreviewComponents(1, "interestCard", new interestCard(undefined, {}));
    previewComponent();
}
else {
}
