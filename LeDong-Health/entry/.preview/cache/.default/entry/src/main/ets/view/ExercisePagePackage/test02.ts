...
class ExercisePage2 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("view/ExercisePagePackage/test02.ets(27:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //首页，搜索栏
            Row.create({ space: 20 });
            Row.debugLine("view/ExercisePagePackage/test02.ets(29:7)");
            //首页，搜索栏
            Row.height('10%');
            //首页，搜索栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('运动');
            Text.debugLine("view/ExercisePagePackage/test02.ets(30:9)");
            Text.fontSize(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("view/ExercisePagePackage/test02.ets(40:7)");
            //运动选择按钮
            List.height('5%');
            //运动选择按钮
            List.width('90%');
            ...
            const forEachItemGenFunction = _item => {
                const exerciseChoice = _item;
                {
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("view/ExercisePagePackage/test02.ets(42:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                    ...
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Button.debugLine("view/ExercisePagePackage/test02.ets(43:13)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("view/ExercisePagePackage/test02.ets(63:7)");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //消息提示
            Row.create();
            Row.debugLine("view/ExercisePagePackage/test02.ets(66:7)");
            //消息提示
            Row.width('90%');
            //消息提示
            Row.height('5%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/ExercisePagePackage/test02.ets(67:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ExercisePagePackage/test02.ets(72:9)");
            Text.fontSize(20);
            Text.padding({ left: 10 });
            Text.opacity(0.9);
            Text.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //打卡计划推荐+每日打卡领金币
            Row.create();
            Row.debugLine("view/ExercisePagePackage/test02.ets(88:7)");
            //打卡计划推荐+每日打卡领金币
            Row.height('5%');
            //打卡计划推荐+每日打卡领金币
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('打卡计划推荐   ');
            Text.debugLine("view/ExercisePagePackage/test02.ets(89:9)");
            Text.fontSize(25);
            Text.padding({ left: '5%' });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('每日打卡领金币');
            Text.debugLine("view/ExercisePagePackage/test02.ets(93:9)");
            Text.fontSize(20);
            Text.opacity(0.6);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("view/ExercisePagePackage/test02.ets(102:7)");
            //健康数据图片
            List.width('100%');
            //健康数据图片
            List.listDirection(Axis.Horizontal);
        ...
        }, List);
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("view/ExercisePagePackage/test02.ets(103:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/ExercisePagePackage/test02.ets(106:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, true);
                ListItem.debugLine("view/ExercisePagePackage/test02.ets(109:9)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
