...
export default class bottomNextStep extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("view/GuidancePagePackage/bottomNextStep.ets(22:5)");
            Row.width('100%');
            Row.height('20%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/GuidancePagePackage/bottomNextStep.ets(24:7)");
            //上一页按钮
            Text.fontSize(40);
            //上一页按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/GuidancePagePackage/bottomNextStep.ets(35:7)");
            //语音输入按钮
            Image.width('31%');
            //语音输入按钮
            Image.height('72%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //下一页按钮
            Row.create();
            Row.debugLine("view/GuidancePagePackage/bottomNextStep.ets(42:7)");
            //下一页按钮
            Row.onClick(() => {
                router.clear();
                router.pushUrl({ url: this.urls[this.index + 1] });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/GuidancePagePackage/bottomNextStep.ets(43:9)");
            Text.fontSize(20);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('>');
            Text.debugLine("view/GuidancePagePackage/bottomNextStep.ets(46:9)");
            Text.fontSize(40);
...
if (getPreviewComponentFlag()) {
    storePreviewComponents(1, "bottomNextStep", new bottomNextStep(undefined, {}));
    previewComponent();
}
else {
}
