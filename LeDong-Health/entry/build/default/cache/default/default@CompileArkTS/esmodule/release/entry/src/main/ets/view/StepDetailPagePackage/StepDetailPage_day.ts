...
class StepDetailPage_day extends ViewPU {
    ...
    setInitiallyProvidedValue(a: StepDetailPage_day_Params) {
    }
    updateStateVars(a: StepDetailPage_day_Params) {
    }
                ...
                this.updateFuncByElmtId.set(e, b);
                {
                    this.observeComponentCreation2((h, i) => {
                        if (i) {
                            ...
                            ViewPU.create(new TimeChooser(this, { time: 0 }, undefined, h, j));
                        }
                        else {
