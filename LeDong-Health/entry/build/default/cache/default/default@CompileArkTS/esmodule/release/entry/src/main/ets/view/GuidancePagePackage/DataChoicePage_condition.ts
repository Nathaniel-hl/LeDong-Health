...
class DataChoicePage_condition extends ViewPU {
    ...
    setInitiallyProvidedValue(a: DataChoicePage_condition_Params) {
        if (a.items !== undefined) {
            this.items = a.items;
        }
    }
    updateStateVars(a: DataChoicePage_condition_Params) {
    }
        ...
        }, Column);
        {
            this.observeComponentCreation2((c, d) => {
                if (d) {
                    ...
                    ViewPU.create(new Progressbar(this, { value: 75 }, undefined, c, e));
                }
                else {
        ...
        Blank.pop();
        {
            this.observeComponentCreation2((c, d) => {
                if (d) {
                    ...
                    ViewPU.create(new bottomNextStep(this, { index: 3 }, undefined, c, e));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(c, {});
                }
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((e, f) => {
                if (f) {
                    ...
                    ViewPU.create(new DiseaseCard(this, { index: a.index1 }, undefined, e, g));
                }
                else {
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((e, f) => {
                if (f) {
                    ...
                    ViewPU.create(new 
                    // Blank(15)
                    DiseaseCard(this, { index: a.index2 }, undefined, e, g));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(e, {});
                }
